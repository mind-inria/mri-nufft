...
An example to show how to reconstruct volumes using a Least Square minimization..
...
from mrinufft.extras.lsqr import lsqr

reconstructed_image, acond = lsqr(nufft, kspace_data_gpu, max_iter=1)
