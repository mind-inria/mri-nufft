...
# the number of stacks and the acceleration factor. It is typically used to keep
# the center of the k-space with a higher density of shots.
# If a ``float`` this is a fraction of the total dim_size. If ``int`` it is
# directly the number of lines.
...
# ``accel (int)``
# ~~~~~~~~~~~~~~~
# Acceleration factor to subsamples the outer region of the k-space.
...
# ``order (str)``
# ~~~~~~~~~~~~~~~
# Determines the ordering of the shot in the trajectory.
# Accepeted values are "top-down", "top-down" or "random".
dim_size = 128
arguments = [
    "center-out",
    "random",
